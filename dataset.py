...
class CoRTO(BaseData):
    ...
    def __init__(self, data_root: "data_root/"):
        ...
        self._content = {
            ...
            "dim_features": 10,
            "features": {
                "upon": [{"filename": "data_root/name/filename/features.pkl",
                          "md5": "f5070e8810bc0e6577ac0ff4022f5bfb"}],
                "loader": load_from_pickle,
                "preprocess": [to_tensor, partial(norm_ft, ord=1)],
            },
            "edge_list": {
                "upon": [{"filename": "data_root/name/filename/edge_list.pkl",
                          "md5": "4a0caa73e265e3b87697efab42da486a"}],
                "loader": load_from_pickle,
            },
            "labels": {
                "upon": [{"filename": "data_root/name/filename/labels.pkl",
                          "md5": "931f196b3f97d5e67ea684142421d541"}],
                "loader": load_from_pickle,
                "preprocess": [to_long_tensor],
            },
            "train_mask": {
                "upon": [{"filename": "data_root/name/filename/train_mask.pkl",
                          "md5": "971ea98e98112731efef799b9deac968"}],
                "loader": load_from_pickle,
                "preprocess": [to_bool_tensor],
            },
            "val_mask": {
                "upon": [{"filename": "data_root/name/filename/val_mask.pkl",
                          "md5": "e30b2503523ef31d68e38d709eacb9c3"}],
                "loader": load_from_pickle,
                "preprocess": [to_bool_tensor],
            },
            "test_mask": {
                "upon": [{"filename": "data_root/name/filename/test_mask.pkl",
